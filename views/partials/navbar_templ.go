...
func Navbar(username string, fromProtected bool) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if fromProtected {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</li><li><a hx-swap=\"transition:true\" href=\"/player\">Players</a></li><li><a hx-swap=\"transition:true\" href=\"/matches\">Matches</a></li><li><button hx-swap=\"transition:true\" hx-post=\"/player/logout\" hx-confirm=\"Are you sure you want to log out?\" hx-target=\"body\" hx-push-url=\"true\" class=\"btn btn-ghost text-lg\">Logout</button></li>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		} else {
